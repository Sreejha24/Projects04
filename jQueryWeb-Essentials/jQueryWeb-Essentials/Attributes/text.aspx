<%@ Page Title="jQuery text Attribute demo" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="text.aspx.cs" Inherits="Attributes_addClass" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    
    <h3>jQuery text Attribute demo</h3>   
    <div>
    ...
    <div id="div2" class="class1">Demo of some <b>jQuery</b> Attributes</div>
    ...
    <script>
        ...
        $(function () {
            ...
            $("#div3").html("This text is set by <b>jQuery</b> !");
        });
    </script>
