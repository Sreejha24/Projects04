<%@ Page Title="jQuery How to - Limit length demo" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="limitLenght.aspx.cs" Inherits="Howto_limitLength" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    
    <h3>jQuery How to - Limit length demo</h3> 
    <br /> 
    <h1>
